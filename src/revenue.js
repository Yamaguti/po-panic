...
Revenue.addRevenue = function(event){
    ...
    Revenue.revenue += Revenue.revenuePerSecond * 0.25
    var feedbackGroup = new PIXI.Container()
    var text = new PIXI.Text("+ " + Math.floor(Revenue.revenuePerSecond * 0.25) + "$",{fontFamily : 'gameFontBold', fontSize: 12, align : 'center', fill: 0x000000});
